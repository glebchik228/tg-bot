...
public class WeatherService {
    ...
    public static String getWeather(WeatherModel model) throws IOException, ParseException{
        URL url = new URL("https://api.openweathermap.org/data/2.5/weather?q=Saint Petersburg&appid=68e0207421564cb8cf77b20c7de8d1dc&units=metric");
        ...
        //model.setDate(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").parse(object.getString("M.state.weather.cw[\"date\"]")));
